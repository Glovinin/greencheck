          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className={`rounded-xl ${isDark ? 'bg-[#EED5B9]/5' : 'bg-[#4F3621]/5'} overflow-hidden`}>
                  <table className={`min-w-full divide-y ${isDark ? 'divide-[#EED5B9]/20' : 'divide-[#4F3621]/20'}`}>
                    <thead className={`${isDark ? 'bg-[#EED5B9]/10' : 'bg-[#4F3621]/10'}`}>
                      <tr>
                    ...
                    <tbody className={`divide-y ${isDark ? 'divide-[#EED5B9]/10' : 'divide-[#4F3621]/20'}`}>
                      <tr>
                      ...
                      <tr className={`${isDark ? 'bg-[#EED5B9]/5' : 'bg-[#4F3621]/5'}`}>
                ...
                <p className={`text-sm ${isDark ? 'text-[#EED5B9]/70' : 'text-[#4F3621]/70'} mt-2`}>

          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            >
              <div className="order-2 md:order-1">
                ...
                <h3 className={`text-3xl font-bold mb-6 ${
                  isDark ? 'text-[#EED5B9]' : 'text-[#4F3621]'
                }`}>Realize o Casamento dos Seus Sonhos</h3>
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start">
                    ...
                    <span className={isDark ? 'text-[#EED5B9]/80' : 'text-[#4F3621]/80'}>Cerimônias ao ar livre com vista para a serra</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                    <span className={isDark ? 'text-[#EED5B9]/80' : 'text-[#4F3621]/80'}>Salão de festas para até 200 convidados</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                    <span className={isDark ? 'text-[#EED5B9]/80' : 'text-[#4F3621]/80'}>Equipe de gastronomia dedicada com menu personalizado</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                    <span className={isDark ? 'text-[#EED5B9]/80' : 'text-[#4F3621]/80'}>Pacotes especiais de hospedagem para noivos e convidados</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                    <span className={isDark ? 'text-[#EED5B9]/80' : 'text-[#4F3621]/80'}>Coordenador de eventos exclusivo para o seu casamento</span>
                  </li>
                </ul>
                <Button 
              ...
              <div className="order-1 md:order-2">
                <div className={`overflow-hidden rounded-3xl shadow-xl group relative ${
                  isDark ? 'shadow-black/20' : 'shadow-[#4F3621]/20'
                }`}>
                  <div className={`absolute inset-0 z-10 transition-colors duration-500 ${
                    isDark 
                  ...
                  <div className={`absolute inset-0 opacity-70 group-hover:opacity-90 transition-opacity duration-300 flex items-end p-6 z-20 ${
                    ...
                    <div>
                      <p className={`font-medium text-xl transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300 ${
                        isDark ? 'text-white' : 'text-[#EED5B9]'
                      }`}>Casamentos Inesquecíveis</p>
                      ...
                      }`}>Momentos eternizados com a beleza da Serra de Monchique como pano de fundo.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
                ...
                <div className={`overflow-hidden rounded-3xl shadow-xl group relative ${
                  ...
                  <div className={`absolute inset-0 opacity-70 group-hover:opacity-90 transition-opacity duration-300 flex items-end p-6 z-20 ${
                    ...
                    <div>
                      ...
                      <p className={`text-sm mt-2 max-w-md opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${
                        isDark ? 'text-white/70' : 'text-[#EED5B9]/70'
                      }`}>Treinamentos, conferências e celebrações empresariais em um ambiente inspirador.</p>
                    </div>
                  </div>
                </div>
              </div>
              <div>
                ...
                <h3 className={`text-3xl font-bold mb-6 ${
                  isDark ? 'text-[#EED5B9]' : 'text-[#4F3621]'
                }`}>Espaços Versáteis para Sua Empresa</h3>
                <p className={`mb-6 leading-relaxed ${
                  isDark ? 'text-[#EED5B9]/70' : 'text-[#4F3621]/70'
                }`}>
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                    <span className={isDark ? 'text-[#EED5B9]/80' : 'text-[#4F3621]/80'}>Salas de reunião equipadas com tecnologia audiovisual</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                    <span className={isDark ? 'text-[#EED5B9]/80' : 'text-[#4F3621]/80'}>Auditório com capacidade para 120 pessoas</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                    <span className={isDark ? 'text-[#EED5B9]/80' : 'text-[#4F3621]/80'}>Internet de alta velocidade e suporte técnico</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                    <span className={isDark ? 'text-[#EED5B9]/80' : 'text-[#4F3621]/80'}>Coffee breaks e serviços de catering empresarial</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                    <span className={isDark ? 'text-[#EED5B9]/80' : 'text-[#4F3621]/80'}>Atividades de team building em contato com a natureza</span>
                  </li>
                </ul>
                <Button 
                  className="rounded-full group bg-primary/10 hover:bg-primary/20 text-primary border border-primary/20"
            ...
            >
              <div className="order-2 md:order-1">
                ...
                <h3 className={`text-3xl font-bold mb-6 ${
                  isDark ? 'text-[#EED5B9]' : 'text-[#4F3621]'
                }`}>Comemore Momentos Importantes</h3>
                <p className={`mb-6 leading-relaxed ${
                  isDark ? 'text-[#EED5B9]/70' : 'text-[#4F3621]/70'
                }`}>
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                    <span className={isDark ? 'text-[#EED5B9]/80' : 'text-[#4F3621]/80'}>Diferentes ambientes para festas de todos os tamanhos</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                    <span className={isDark ? 'text-[#EED5B9]/80' : 'text-[#4F3621]/80'}>Decoração personalizada para cada ocasião</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                    <span className={isDark ? 'text-[#EED5B9]/80' : 'text-[#4F3621]/80'}>Gastronomia adaptada ao estilo da sua celebração</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                    <span className={isDark ? 'text-[#EED5B9]/80' : 'text-[#4F3621]/80'}>Pacotes de música e entretenimento disponíveis</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                    <span className={isDark ? 'text-[#EED5B9]/80' : 'text-[#4F3621]/80'}>Serviço atencioso e personalizado para seus convidados</span>
                  </li>
                </ul>
                <Button 
                  className="rounded-full group bg-primary/10 hover:bg-primary/20 text-primary border border-primary/20"
                ...
                <div className={`overflow-hidden rounded-3xl shadow-xl group relative ${
                  ...
                  <div className={`absolute inset-0 opacity-70 group-hover:opacity-90 transition-opacity duration-300 flex items-end p-6 z-20 ${
                    ...
                    <div>
                      <p className={`font-medium text-xl transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300 ${
                        isDark ? 'text-white' : 'text-[#EED5B9]'
                      }`}>Celebrações Memoráveis</p>
                      <p className={`text-sm mt-2 max-w-md opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${
                        isDark ? 'text-white/70' : 'text-[#EED5B9]/70'
                      }`}>Aniversários, festas temáticas e encontros familiares em um ambiente sofisticado.</p>
                    </div>
                  </div>
                </div>
              </div>
